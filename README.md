...
10      | Oct. 31 - Nov. 4     |  <ul><li>ROS Communication: Publisher/Subscriber and Service and Client.</li> <li>Project 3: Robot Manipulation/Mapping.</li></ul>  | <ul><li>Project 3 work on November 1st.</li> <li>Activity 12 - Nov 3rd.</li> <li>Project 3 Work on November 3rd in lab.</li></ul> | [ROS Tutorials](https://docs.ros.org/en/humble/Tutorials/Beginner-Client-Libraries.html)
11      | Nov. 7 - Nov. 11     |   <ul> <li>Planning.</li></ul> | <ul><li><Project 3 Demonstrations on November 8th.</li> <li>Class "Hot Topic" Presentations Work on November 8th with Presentations on November 10th in class.</li> <li>Project 4 Work on November 10th in lab.</li></ul> | Read [Chapter 13 in "Introduction to Autonomous Robots"](https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots/blob/master/book-12-01-21-full.pdf).
