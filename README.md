...
11      | Nov. 7 - Nov. 11     |   <ul> <li>ROS Communication: Publisher/Subscriber and Service and Client.</li> </ul> | <ul><li>Project 3 Demonstrations on November 8th.</li>  <li>Project 4 Work on November 10th in lab.</li></ul> | [ROS Tutorials](https://docs.ros.org/en/galactic/Tutorials/Beginner-Client-Libraries.html).
12      | Nov. 14 - Nov. 18     |  Planning  | <ul><li>Project 4 work.</li> <li>Final project released.</li></ul> | Read [Chapter 13 in "Introduction to Autonomous Robots"](https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots/blob/master/book-12-01-21-full.pdf).
13      | Nov. 21 - Nov. 25     |  Thanksgiving break Nov. 23-25  |  Project 4 Demonstrations on November 22nd. | 
14      | Nov. 28 - Dec. 2     | Class "Hot Topic" Presentations. Vision and Machine learning in robotics. |  Final Project work. | Read [Chapters 8 and 10 in "Introduction to Autonomous Robots"](https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots/blob/master/book-12-01-21-full.pdf).
