...
9      | Oct. 24 - Oct. 28     |  <ul><li>No class on Oct. 25.</li> <li>Understanding ROS.</li> <li>Project: Robot Manipulation/Mapping.</li></ul> | <ul><li>[Activity 10: Continue ROS Beginner Tutorials](https://classroom.github.com/a/i4MQCX_m).</li> <li>Guest speaker on October 27th: robotics industry and careers.</li></ul> | <ul><li>[ROS CLI Tutorials](https://docs.ros.org/en/humble/Tutorials/Beginner-CLI-Tools.html).</li> <li>Read [Chapters 12 and 14 in "Introduction to Autonomous Robots"](https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots/blob/master/book-12-01-21-full.pdf)</li></ul>
10      | Oct. 31 - Nov. 4     |  <ul><li>ROS Communication: Publisher/Subscriber and Service and Client.</li> <li>Project 3: Robot Manipulation/Mapping.</li></ul>  | <ul><li>Project 3 work on November 1st. </li> <li>Activity 11 - Nov 3rd.</li> <li>Project 3 Demonstrations on November 3rd - lab.</li></ul> | [ROS Tutorials](https://docs.ros.org/en/humble/Tutorials/Beginner-Client-Libraries.html)
11      | Nov. 7 - Nov. 11     |   <ul> <li>Planning.</li></ul>| <ul><li>Class "Hot Topic" Presentations.</li><li>Project 4 work.</li></ul> | Read [Chapter 13 in "Introduction to Autonomous Robots"](https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots/blob/master/book-12-01-21-full.pdf).
12      | Nov. 14 - Nov. 18     |  Vision and Machine learning in robotics.   | <ul><li>Project 4 work.</li> <li>Final project released.</li></ul> | Read [Chapters 8 and 10 in "Introduction to Autonomous Robots"](https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots/blob/master/book-12-01-21-full.pdf).
13      | Nov. 21 - Nov. 25     |  Thanksgiving break Nov. 23-25  |  Project 4 Demonstrations on November 22nd. | 
14      | Nov. 28 - Dec. 2     | Class "Hot Topic" Presentations. Reinforcement learning. |  Final Project work. | 
15      | Dec. 5 - Dec. 9     |    Reinforcement learning.   |  Final Project work. | 
16      | Dec. 12 - Dec. 16     |   Project work. Exam 2 given on December 15th.  |  Community Event.  | 
17      | Dec. 19 - Dec. 23     | Exam 2 and Project.   |   Exam 2 DUE on December 19th. | 
