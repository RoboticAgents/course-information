...
14      | Nov. 28 - Dec. 2     | <ul><li>ROS Communication.</li> <li>Vision and Machine learning in robotics.</li></ul> |  Final Project work. | <ul><li> [ROS Tutorials](https://docs.ros.org/en/galactic/Tutorials/Beginner-Client-Libraries.html)</li> <li>Read [Chapters 8 and 10 in "Introduction to Autonomous Robots"](https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots/blob/master/book-12-01-21-full.pdf).</li></ul>
