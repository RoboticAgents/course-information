...
13      | Nov. 21 - Nov. 25     |  Thanksgiving break Nov. 23-25  | ROS Communication | [ROS Tutorials](https://docs.ros.org/en/galactic/Tutorials/Beginner-Client-Libraries.html)
14      | Nov. 28 - Dec. 2     | <ul><li>Class "Hot Topic" Presentations.</li> <li>Vision and Machine learning in robotics.</li></ul> |  Final Project work. | Read [Chapters 8 and 10 in "Introduction to Autonomous Robots"](https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots/blob/master/book-12-01-21-full.pdf).
